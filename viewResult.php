...
<tr><td class="labels" style="color:red;">SUBJECTS</td><td class="labels" style="color:red;">MARKS</td></tr>
...
<tr style="color:#0F0;"><td class="labels">TOTAL  </td><td class="labels"><?php echo $b['total'];?> </td></tr>
