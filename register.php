...
if($roll==NULL || $sem==NULL || $email==NULL || $nam==NULL || $_POST['pass']==NULL)
{
	//
}
else
{
	$sql=mysqli_query($al,"INSERT INTO students(name,roll,sem,email,password) VALUES('$nam','$roll','$sem','$email','$pass')");
	if($sql)
	{
...
<tr><td class="labels">Reg No.:</td><td><input type="text" name="roll" class="fields" required="required" size="15" placeholder="Enter Roll No." /></td></tr>
